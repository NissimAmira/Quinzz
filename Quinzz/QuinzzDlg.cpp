...
// QuinzzDlg.cpp : implementation file
//
...
// CQuinzzDlg message handlers

BOOL CQuinzzDlg::OnInitDialog()
{
...
void CQuinzzDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CQuinzzDlg::OnQueryDragIcon()
{
...
void CQuinzzDlg::OnBnClickedNewTest()
{
	...
	DashboardDlg dashboard_dlg(NULL, nameOfOwner);
	dashboard_dlg.DoModal();
}
